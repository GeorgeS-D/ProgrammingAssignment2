...
### Avoid deviating from the exemplar functions makeVector() and cachemean()
### because most of your peers are new to R and possibly to programming in
### general. People in previous sessions got clever and paid dearly during the
### peer evaluation phase of Programming Assignment 2. Keep it easy...change
### the function names, substitute the appropriate function to replace mean(),
### add comments explaining each of the two functions, change the names as
### appropriate of the inner functions of the exemplars. We are not asking you
### to implement production-quality, real-world functions. The object lesson is
### to learn about lexical scoping and lazy evaluation.
###============================================================================
...
# cache rather than recomputed. In this Programming Assignment will take
